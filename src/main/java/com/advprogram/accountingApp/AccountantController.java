...
public class AccountantController {
    @FXML private JFXButton btnProfilePage, btnPrsnlInfo,  VboxBtnAddEmp ,
             btnLogout, btnExit;
    @FXML private Button btnAddEmp;
    @FXML private Label lblProfName, lblAccNo;
    @FXML private AnchorPane profilePage, PersonnelTablePage, EmpAddPage;
    @FXML private TextField txtOfsprngeEntrnc , txtIDEntrnc, txtNameEntrnc, txtLastNameEntrnc , txtTitlEntrnc;
    @FXML private TableView PersonnelTable;
    @FXML private TableColumn clmnFirstName , clmnLastName , clmnTitle;
